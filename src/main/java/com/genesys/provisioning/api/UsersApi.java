...
import com.genesys.provisioning.model.DeleteUserData;
import com.genesys.provisioning.model.GetUserSkillsSuccessResponse;
import com.genesys.provisioning.model.GetUsersSuccessResponse;
import com.genesys.provisioning.model.UpdateUserData;
...
public class UsersApi {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getUserSkillsValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = getUserSkillsCall(progressListener, progressRequestListener);
        return call;
     ...
     * @return GetUserSkillsSuccessResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetUserSkillsSuccessResponse getUserSkills() throws ApiException {
        ApiResponse<GetUserSkillsSuccessResponse> resp = getUserSkillsWithHttpInfo();
        return resp.getData();
    }
     ...
     * Get skills of users
     * The GET operation will return CfgSkill objects actually linked with existing CfgPerson objects
     * @return ApiResponse&lt;GetUserSkillsSuccessResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetUserSkillsSuccessResponse> getUserSkillsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getUserSkillsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<GetUserSkillsSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserSkillsAsync(final ApiCallback<GetUserSkillsSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUserSkillsValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetUserSkillsSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
