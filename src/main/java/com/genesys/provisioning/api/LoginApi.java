...
public class LoginApi {
     ...
     */
    public LoginSuccessResponse login(Login body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<LoginSuccessResponse> loginWithHttpInfo(Login body) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call loginAsync(Login body, final ApiCallback<LoginSuccessResponse> callback) throws ApiException {
