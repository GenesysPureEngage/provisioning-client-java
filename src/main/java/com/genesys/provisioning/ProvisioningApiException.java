...
public class ProvisioningApiException extends Exception {
    public ProvisioningApiException(String msg) {
        super(msg);
    }

    public ProvisioningApiException(String msg, Exception cause) {
        super(msg, cause);
    }
