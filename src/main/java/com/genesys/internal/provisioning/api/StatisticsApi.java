...
public class StatisticsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postImportStatisticDefinitionsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postImportStatisticDefinitionsValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = postImportStatisticDefinitionsCall(progressListener, progressRequestListener);
        return call;
    ...
    public PostImportStatisticDefinitions postImportStatisticDefinitions() throws ApiException {
        ApiResponse<PostImportStatisticDefinitions> resp = postImportStatisticDefinitionsWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postImportStatisticDefinitionsAsync(final ApiCallback<PostImportStatisticDefinitions> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postImportStatisticDefinitionsValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostImportStatisticDefinitions>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param resetTime Set to dynamicTimeProfile of matching stat (required)
     * @param location The normalized location (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postUpdateResetTimesStatisticsCall(String resetTime, String location, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/statistic-definitions/operations/update-reset-times"
            .replaceAll("\\{" + "resetTime" + "\\}", apiClient.escapeString(resetTime.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postUpdateResetTimesStatisticsValidateBeforeCall(String resetTime, String location, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'resetTime' is set
        if (resetTime == null) {
        ...
        com.squareup.okhttp.Call call = postUpdateResetTimesStatisticsCall(resetTime, location, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PostUpdateResetTimesStatistics postUpdateResetTimesStatistics(String resetTime, String location) throws ApiException {
        ApiResponse<PostUpdateResetTimesStatistics> resp = postUpdateResetTimesStatisticsWithHttpInfo(resetTime, location);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PostUpdateResetTimesStatistics> postUpdateResetTimesStatisticsWithHttpInfo(String resetTime, String location) throws ApiException {
        com.squareup.okhttp.Call call = postUpdateResetTimesStatisticsValidateBeforeCall(resetTime, location, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postUpdateResetTimesStatisticsAsync(String resetTime, String location, final ApiCallback<PostUpdateResetTimesStatistics> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postUpdateResetTimesStatisticsValidateBeforeCall(resetTime, location, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostUpdateResetTimesStatistics>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
