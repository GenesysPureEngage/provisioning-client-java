...
import com.genesys.internal.provisioning.model.DeleteMetadataResponse;
import java.io.File;
...
import com.genesys.internal.provisioning.model.PostLocationResponse;
...
public class SamlSettingsApi {
     ...
     */
    public com.squareup.okhttp.Call deleteMetadataCall(String location, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call deleteMetadataValidateBeforeCall(String location, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = deleteMetadataCall(location, progressListener, progressRequestListener);
        return call;
    ...
    public DeleteMetadataResponse deleteMetadata(String location) throws ApiException {
        ApiResponse<DeleteMetadataResponse> resp = deleteMetadataWithHttpInfo(location);
        return resp.getData();
    }
     ...
     * Delete metadata.
     * @param location The region where send metadata. (optional)
     * @return ApiResponse&lt;DeleteMetadataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    ...
    /**
     * Delete upload metadata. (asynchronously)
     * Delete metadata.
     * @param location The region where send metadata. (optional)
     ...
     */
    public com.squareup.okhttp.Call deleteMetadataAsync(String location, final ApiCallback<DeleteMetadataResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteMetadataValidateBeforeCall(location, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeleteMetadataResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postLocationCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postLocationValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = postLocationCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PostLocationResponse postLocation() throws ApiException {
        ApiResponse<PostLocationResponse> resp = postLocationWithHttpInfo();
        return resp.getData();
    }
    ...
    /**
     * Set main settings. (asynchronously)
     * Change global settings.
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postLocationAsync(final ApiCallback<PostLocationResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postLocationValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostLocationResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
