...
public class CapacityRulesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call capRulesPutCall(CaprulePut body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call capRulesPutValidateBeforeCall(CaprulePut body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = capRulesPutCall(body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CaprulesPutResponseStatusSuccess capRulesPut(CaprulePut body) throws ApiException {
        ApiResponse<CaprulesPutResponseStatusSuccess> resp = capRulesPutWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CaprulesPutResponseStatusSuccess> capRulesPutWithHttpInfo(CaprulePut body) throws ApiException {
        com.squareup.okhttp.Call call = capRulesPutValidateBeforeCall(body, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call capRulesPutAsync(CaprulePut body, final ApiCallback<CaprulesPutResponseStatusSuccess> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = capRulesPutValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CaprulesPutResponseStatusSuccess>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
