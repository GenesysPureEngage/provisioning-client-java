...
public class GetAnyLocationsResponseData {
  ...
  public GetAnyLocationsResponseData useExternalUserId(Boolean useExternalUserId) {
    this.useExternalUserId = useExternalUserId;
    return this;
  }

   /**
   * Defines is uses ExternalUserId.
   * @return useExternalUserId
  **/
  @ApiModelProperty(value = "Defines is uses ExternalUserId.")
  public Boolean UseExternalUserId() {
    return useExternalUserId;
  }
  ...
  public GetAnyLocationsResponseData accessGroups(List<String> accessGroups) {
    this.accessGroups = accessGroups;
    return this;
  }

  public GetAnyLocationsResponseData addAccessGroupsItem(String accessGroupsItem) {
  ...
  **/
  ...
  public GetAnyLocationsResponseData serviceProviderBaseURL(String serviceProviderBaseURL) {
    this.serviceProviderBaseURL = serviceProviderBaseURL;
    return this;
  }

   /**
   * Defines exist Service Provider Base URL.
   * @return serviceProviderBaseURL
  **/
  @ApiModelProperty(value = "Defines exist Service Provider Base URL.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetAnyLocationsResponseData getAnyLocationsResponseData = (GetAnyLocationsResponseData) o;
    return Objects.equals(this.useExternalUserId, getAnyLocationsResponseData.useExternalUserId) &&
        Objects.equals(this.accessGroups, getAnyLocationsResponseData.accessGroups) &&
        Objects.equals(this.serviceProviderBaseURL, getAnyLocationsResponseData.serviceProviderBaseURL);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAnyLocationsResponseData {\n");
