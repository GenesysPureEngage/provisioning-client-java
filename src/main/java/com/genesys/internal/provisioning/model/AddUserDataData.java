...
public class AddUserDataData {
  ...
  **/
   ...
   * @return folder
  **/
  @ApiModelProperty(value = "The location where the Provisioning API should create the user. This is also where the API creates DNs, places, agent logins and so on. If not specified, the API creates the user in a root folder. ")
