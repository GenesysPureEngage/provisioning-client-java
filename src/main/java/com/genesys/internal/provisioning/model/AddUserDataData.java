 ...
 * AddUserDataData
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-05-17T03:22:26.420Z")
public class AddUserDataData {
  ...
  **/
  ...
  public AddUserDataData callRecording(Boolean callRecording) {
  ...
  **/
  ...
  public AddUserDataData capacityRule(String capacityRule) {
  ...
  **/
  ...
  public AddUserDataData recordingHierarchy(String recordingHierarchy) {
    this.recordingHierarchy = recordingHierarchy;
    return this;
  }

   /**
   * The recording hierarchy for this agent that specifies the access control applied to recordings of calls handled by this agent 
   * @return recordingHierarchy
  **/
  @ApiModelProperty(value = "The recording hierarchy for this agent that specifies the access control applied to recordings of calls handled by this agent ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.changePasswordOnNextLogin, addUserDataData.changePasswordOnNextLogin) &&
        ...
        Objects.equals(this.capacityRule, addUserDataData.capacityRule) &&
        Objects.equals(this.recordingHierarchy, addUserDataData.recordingHierarchy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(changePasswordOnNextLogin, emailAddress, employeeID, externalID, enabled, folder, userName, firstName, lastName, loginCode, password, placeNames, isAgent, callRecording, wwe, switchNames, phones, supportSoftPhone, sipPhoneType, skills, agentGroups, accessGroups, voiceMail, wrapUpTime, capacityRule, recordingHierarchy);
  }
