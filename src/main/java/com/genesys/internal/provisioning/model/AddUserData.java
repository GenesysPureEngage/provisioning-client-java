...
public class AddUserData {
  ...
  **/
  @ApiModelProperty(value = "if 'true' (default 'false'), user will be asked to change password on first login.  Effect: Controls the value of the corresponding CfgPerson attribute ")
  ...
  **/
   ...
   * @return folder
  **/
  @ApiModelProperty(value = "Folder where create a new user. If no folder is specified user will be created in a root folder  Effect: User, DNs, Places, AgentLogins etc will be created in a selected folder. ")
  ...
  **/
  @ApiModelProperty(value = "Enable SIP Phone, true/false (default 'false').  Effect: Writes corresponding information to the TServer annex of the created DNs (see sipPhoneType) ")
