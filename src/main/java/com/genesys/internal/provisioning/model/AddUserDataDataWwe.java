...
public class AddUserDataDataWwe {
  ...
  public AddUserDataDataWwe addRolesItem(String rolesItem) {
   ...
   /**
   * The roles that are added to the user. If **isAgent** is &#x60;true&#x60;, set this field to &#x60;ROLE_AGENT&#x60;. 
   * @return roles
  **/
  @ApiModelProperty(value = "The roles that are added to the user. If **isAgent** is `true`, set this field to `ROLE_AGENT`. ")
