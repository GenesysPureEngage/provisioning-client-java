...
public class GetUsersSuccessResponseData {
  ...
  public GetUsersSuccessResponseData addUsersItem(Object usersItem) {
   ...
   /**
   * A list of user objects returned if the Provisioning API can&#39;t find the specified user.
   * @return users
  **/
  @ApiModelProperty(value = "A list of user objects returned if the Provisioning API can't find the specified user.")
   ...
   * @return user
  **/
  @ApiModelProperty(value = "The user object for the specified user.")
  ...
  public GetUsersSuccessResponseData totalCount(Integer totalCount) {
   ...
   /**
   * Total number of users. Available if dbid parameter is absent. This is only present when the Provisioning API can&#39;t find the specified user and returns a list of user objects. 
   * @return totalCount
  **/
  @ApiModelProperty(value = "Total number of users. Available if dbid parameter is absent. This is only present when the Provisioning API can't find the specified user and returns a list of user objects. ")
