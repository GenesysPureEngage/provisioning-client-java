...
public class GetUsersSuccessResponseData {
  ...
  **/
  ...
  public GetUsersSuccessResponseData totalCount(Integer totalCount) {
   ...
   /**
   * Total number of users. This is only present if the DBID parameter is absent or the Provisioning API can&#39;t find the specified user and returns a list of user objects. 
   * @return totalCount
  **/
  @ApiModelProperty(value = "Total number of users. This is only present if the DBID parameter is absent or the Provisioning API can't find the specified user and returns a list of user objects. ")
