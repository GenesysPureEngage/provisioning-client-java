...
import io.swagger.client.model.OptionsGetResponseError;
import io.swagger.client.model.OptionsGetResponseSuccess;
import io.swagger.client.model.OptionsPost;
import io.swagger.client.model.OptionsPostResponseStatusError;
import io.swagger.client.model.OptionsPostResponseStatusSuccess;
import io.swagger.client.model.OptionsPut;
import io.swagger.client.model.OptionsPutResponseError;
import io.swagger.client.model.OptionsPutResponseStatusSuccess;
...
public class OptionsApi {
    ...
    private com.squareup.okhttp.Call optionsGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public OptionsGetResponseSuccess optionsGet() throws ApiException {
        ApiResponse<OptionsGetResponseSuccess> resp = optionsGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<OptionsGetResponseSuccess> optionsGetWithHttpInfo() throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call optionsGetAsync(final ApiCallback<OptionsGetResponseSuccess> callback) throws ApiException {
